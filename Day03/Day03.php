<?php
	...
	class Day03 extends Day
	{
		...
		{
			return $this->_executeMulInstructionsInString($this->InputPart1);
		}
		...
		{
			$doInstructions = preg_replace('/(don\'t[\s\S]*?do\(\))/', '', $this->InputPart2);
			return $this->_executeMulInstructionsInString($doInstructions);
		}

		private function _executeMulInstructionsInString(string $string) : int
		{
			$multiplications = 0;
